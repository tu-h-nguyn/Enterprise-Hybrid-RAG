...
Generated 2026-09-15T09:07:11+00:00 · 50 questions (43 answerable), held fixed throughout.
...
|---|---:|---:|---|---:|---:|---:|---:|---:|---:|
| `numpy` | 44 | 68.18% | Dense only | 0.5155 | 0.8295 | 0.6906 | 10.80 | 0.0000 | 0.0000 |
|  |  |  | BM25 only | 0.5969 | 0.9070 | 0.7694 | 0.20 | 0.0000 | 0.0000 |
|  |  |  | Hybrid (RRF) | 0.5620 | 0.8372 | 0.7362 | 10.92 | 0.0000 | 0.0000 |
|  |  |  | Hybrid + Reranker | 0.7016 | 0.9186 | 0.8568 | 1390.88 | 0.0000 | 0.0000 |
| `numpy` | 235 | 12.77% | Dense only | 0.4574 | 0.6783 | 0.5999 | 11.05 | 0.2326 | 0.5535 |
|  |  |  | BM25 only | 0.5504 | 0.7791 | 0.7062 | 0.50 | 0.0698 | 0.3907 |
|  |  |  | Hybrid (RRF) | 0.5039 | 0.7597 | 0.6716 | 11.59 | 0.2558 | 0.5209 |
|  |  |  | Hybrid + Reranker | 0.6550 | 0.8721 | 0.8101 | 1364.69 | 0.1163 | 0.4233 |
| `numpy` | 936 | 3.21% | Dense only | 0.4109 | 0.5969 | 0.5478 | 10.92 | 0.3488 | 0.6837 |
|  |  |  | BM25 only | 0.5504 | 0.7791 | 0.6991 | 1.63 | 0.0698 | 0.4372 |
|  |  |  | Hybrid (RRF) | 0.4806 | 0.7713 | 0.6565 | 13.58 | 0.3256 | 0.5674 |
|  |  |  | Hybrid + Reranker | 0.6318 | 0.8566 | 0.7950 | 1344.64 | 0.1860 | 0.5581 |
| `numpy` | 4658 | 0.64% | Dense only | 0.3643 | 0.5736 | 0.4957 | 19.14 | 0.4186 | 0.7814 |
|  |  |  | BM25 only | 0.5736 | 0.7558 | 0.7078 | 10.36 | 0.0698 | 0.4279 |
|  |  |  | Hybrid (RRF) | 0.4457 | 0.7597 | 0.6287 | 54.63 | 0.3953 | 0.6093 |
|  |  |  | Hybrid + Reranker | 0.6318 | 0.8566 | 0.7868 | 1411.69 | 0.1628 | 0.6093 |
| `chroma` | 44 | 68.18% | Dense only | 0.5155 | 0.8295 | 0.6906 | 15.51 | 0.0000 | 0.0000 |
|  |  |  | BM25 only | 0.5969 | 0.9070 | 0.7694 | 0.74 | 0.0000 | 0.0000 |
|  |  |  | Hybrid (RRF) | 0.5620 | 0.8372 | 0.7362 | 15.77 | 0.0000 | 0.0000 |
|  |  |  | Hybrid + Reranker | 0.7016 | 0.9186 | 0.8568 | 1383.08 | 0.0000 | 0.0000 |
| `chroma` | 235 | 12.77% | Dense only | 0.4574 | 0.6783 | 0.5999 | 15.80 | 0.2326 | 0.5535 |
|  |  |  | BM25 only | 0.5504 | 0.7791 | 0.7062 | 1.03 | 0.0698 | 0.3907 |
|  |  |  | Hybrid (RRF) | 0.5039 | 0.7597 | 0.6716 | 16.44 | 0.2558 | 0.5209 |
|  |  |  | Hybrid + Reranker | 0.6550 | 0.8721 | 0.8101 | 1355.58 | 0.1163 | 0.4233 |
| `chroma` | 936 | 3.21% | Dense only | 0.4109 | 0.5969 | 0.5478 | 16.51 | 0.3488 | 0.6837 |
|  |  |  | BM25 only | 0.5504 | 0.7791 | 0.6991 | 2.29 | 0.0698 | 0.4372 |
|  |  |  | Hybrid (RRF) | 0.4806 | 0.7713 | 0.6562 | 18.91 | 0.3256 | 0.5674 |
|  |  |  | Hybrid + Reranker | 0.6318 | 0.8566 | 0.7950 | 1350.17 | 0.1860 | 0.5581 |
| `chroma` | 4658 | 0.64% | Dense only | 0.3643 | 0.5504 | 0.4841 | 18.31 | 0.4186 | 0.7860 |
|  |  |  | BM25 only | 0.5736 | 0.7558 | 0.7078 | 13.27 | 0.0698 | 0.4279 |
|  |  |  | Hybrid (RRF) | 0.4457 | 0.7364 | 0.6227 | 32.16 | 0.3953 | 0.6186 |
|  |  |  | Hybrid + Reranker | 0.6318 | 0.8566 | 0.7868 | 1375.24 | 0.1628 | 0.6047 |
...
|---|---:|---:|---:|---:|
| `numpy` | 44 | 22 | 384 | 8.74 |
| `numpy` | 235 | 162 | 384 | 10.40 |
| `numpy` | 936 | 677 | 384 | 32.94 |
| `numpy` | 4658 | 3422 | 384 | 154.99 |
| `chroma` | 44 | 22 | 384 | 4.35 |
| `chroma` | 235 | 162 | 384 | 10.59 |
| `chroma` | 936 | 677 | 384 | 33.95 |
| `chroma` | 4658 | 3422 | 384 | 159.73 |
