...
BM25 only           & 0.6434 & 0.8023 & 0.8023 & 0.8023 & 0.7597 & 0.7660 & \textbf{0.75} \\
Hybrid (RRF)        & 0.6434 & 0.8023 & 0.8488 & \textbf{1.0000} & 0.7910 & 0.7862 & 15.97 \\
\textbf{Hybrid + Reranker} & \textbf{0.7946} & \textbf{0.8953} & 0.9070 & \textbf{1.0000} & \textbf{0.9085} & \textbf{0.8937} & 693.91 \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{itemize}[leftmargin=1.2em,itemsep=3pt]
  \item \textbf{Lint, types and tests} --- \code{ruff}, \code{mypy} over
        \code{app/}, \code{scripts/} and \code{frontend/}, and 174 tests behind a
...
\begin{enumerate}[leftmargin=1.4em,itemsep=3pt]
  ...
  \item \textbf{Reranking dominates latency} --- 693.91\,ms against BM25's
        0.75\,ms. Any deployment must decide whether that precision is worth
...
\code{tests/}          & 174 unit and integration tests \\
